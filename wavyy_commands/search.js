...
module.exports={
    ...
    alias: ["sr","find"],
    usage: '<search word(s)>',
    description: 'Search the top 10 queues and choose one, Wavyy',
    category: 'music',
    ...
    async execute(msg,args,client,Discord,command){
        ...
        if(!args[1]){
            return msg.channel.send(client.messages.noQuery)
        }    

        if(voiceChannel.full){
            return msg.channel.send(client.messages.channelFull);
        }

...
module.exports=async function(guild,song,client,seek,play){
    ...
    const ffmpegArgs=["-analyzedduration","0","-loglevel","0","-f","s16le","-ar","48000","-ac","2"];

    const isStream=input instanceof ReadableStream;

    const arg=isStream?ffmpegArgs.slice():["-i",input,...ffmpegArgs];
    ...
    const embed=new Discord.MessageEmbed()
        ...
        .setDescription(`Song duration: \`${client.funcs.msToTime(queue.songs[0].info.lengthSeconds * 1000,"hh:mm:ss")}\``)
